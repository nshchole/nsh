...
(function($) {
  ...
  10. empty()      : 선택요소의 내부(자식들)를 비우는 메소드 
  11. removeAttr('속성명을 써줘야한다') : 선택요소의 속성을 삭제하는 메소드
  12. attr('속성명', (,'속성값'))       : 선택요소의 속성을 파악/수정/삽입 하는 메소드 (치환)
...
*/
 ...
 // var link = ['http://naver.com', 'http://daum.com', 'http://google.com',
 // 			 'http://behance.com', 'http://pinterest.com', 'http://dribbble.com'];

var productlist = [
	{color:'#ff0', text:'제품_1 에 대한 각각 설명하기', link:'http://naver.com'},
	{color:'#cca', text:'제품_2 에 대한 각각 설명하기', link:'http://daum.com'},
	{color:'#acf', text:'제품_3 에 대한 각각 설명하기', link:'http://google.com'},
	{color:'#f06', text:'제품_4 에 대한 각각 설명하기', link:'http://behance.com'},
	{color:'#f7f', text:'제품_5 에 대한 각각 설명하기', link:'http://pinterest.com'},
	{color:'#afa', text:'제품_6 에 대한 각각 설명하기', link:'http://dribbble.com'}
  ];
 ...
 for(var i=0; i < productList.length; i+=1){
   ...
   // // $('.product').eq(i).find('p').eq(0).(text[i]);
