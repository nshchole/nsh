...
/* ===============================
	...
	02. html()   		 : html 태그를 확인하/ 제작하는 메소드
	03. wrap()   		 : 선택한 요소의 부모요소를 확인/제작하는 메소드
	04. before() 		 : 선택요소의 이전(형제)에 요소를 제작하는 메소드
	05. after()  		 : 선택요소의 이후(형제)에 요소를 제작하는 메소드
	...
	13. val() 			 : form 요소의 값을 파악/삽입하는 메소드
   ===============================*/
...
var myText = '와 함께 jQuery 추가기능 사용하기';
