...
(function($){
  ...
  // moveBtn
  var moveBtn = issue.children('.move.btn');
  var moveBtLi = moveBtn.children('button');
  ...
  // img
  var img = issue.children('.news_img');
  var url = "../../img/img/issueBanner/";
  var imgList = [
        '.issue_banner_01.png',
        '.issue_banner_02.png',
        '.issue_banner_03.png',
  ...
  // ------------------------------------------------------------
  // step1 : indicator를 선택시 해당하는 ul이 나타나게 만들기
  // step2 : dl이 나타날때, imgBg에 해당하는 이미지가 변경되게
  // step3 : dl의 요소가 시간의 순서에 의해 변경되게 만들기
  // ------------------------------------------------------------
  // step4 : 버튼을 선택시 멈추거나 재생되거나 처리하게 만들기
  // step5 : dl의 요소를 json 기법으로 내용을 별도로 담아 자동처리되게 만들기
